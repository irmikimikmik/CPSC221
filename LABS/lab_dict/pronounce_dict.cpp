...
{
    string copyWord1 = word1;
    string copyWord2 = word2;
    std::transform(copyWord1.begin(), copyWord1.end(), copyWord1.begin(), ::toupper);
    std::transform(copyWord2.begin(), copyWord2.end(), copyWord2.begin(), ::toupper);
    auto firstWord = dict.find(copyWord1);
    auto secondWord = dict.find(copyWord2);

    if(firstWord == dict.end() || secondWord == dict.end()){
        return false;
    }
